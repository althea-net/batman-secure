...
ge25519_p1p1_to_partial(ge25519 *r, const ge25519_p1p1 *p) {
	packed64bignum25519 __attribute__((aligned(16))) xz, tt, xzout;
...
ge25519_p1p1_to_full(ge25519 *r, const ge25519_p1p1 *p) {
	packed64bignum25519 __attribute__((aligned(16))) zy, xt, xx, zz, ty;
...
ge25519_add_p1p1(ge25519_p1p1 *r, const ge25519 *p, const ge25519 *q) {
	bignum25519 __attribute__((aligned(16))) a,b,c,d;
	packed32bignum25519 __attribute__((aligned(16))) xx, yy, yypxx, yymxx, bd, ac, bdmac, bdpac;
	packed64bignum25519 __attribute__((aligned(16))) at, bu, atbu, ptz, qtz, cd;
...
ge25519_double_p1p1(ge25519_p1p1 *r, const ge25519 *p) {
	bignum25519 __attribute__((aligned(16))) a,b,c,x;
	packed64bignum25519 __attribute__((aligned(16))) xy, zx, ab, cx;
	packed32bignum25519 __attribute__((aligned(16))) xc, yz, xt, yc, ac, bc;
...
ge25519_nielsadd2_p1p1(ge25519_p1p1 *r, const ge25519 *p, const ge25519_niels *q, unsigned char signbit) {
	...
	bignum25519 __attribute__((aligned(16))) a,b,c;
	packed64bignum25519 __attribute__((aligned(16))) ab, yx, aybx;
	packed32bignum25519 __attribute__((aligned(16))) bd, ac, bdac;
...
ge25519_pnielsadd_p1p1(ge25519_p1p1 *r, const ge25519 *p, const ge25519_pniels *q, unsigned char signbit) {
	...
	bignum25519 *rb = (bignum25519 *)r;
	bignum25519 __attribute__((aligned(16))) a,b,c;
	packed64bignum25519 __attribute__((aligned(16))) ab, yx, aybx, zt, zt2d, tc;
	packed32bignum25519 __attribute__((aligned(16))) bd, ac, bdac;
...
ge25519_double(ge25519 *r, const ge25519 *p) {
	ge25519_p1p1 __attribute__((aligned(16))) t;
...
ge25519_nielsadd2(ge25519 *r, const ge25519_niels *q) {
	packed64bignum25519 __attribute__((aligned(16))) ab, yx, aybx, eg, ff, hh, xz, ty;
	packed32bignum25519 __attribute__((aligned(16))) bd, ac, bdac;
	bignum25519 __attribute__((aligned(16))) a,b,c,d,e,f,g,h;
...
ge25519_pnielsadd(ge25519_pniels *r, const ge25519 *p, const ge25519_pniels *q) {
	ge25519_p1p1 __attribute__((aligned(16))) t;
	ge25519 __attribute__((aligned(16))) f;
...
ge25519_pack(unsigned char r[32], const ge25519 *p) {
	bignum25519 __attribute__((aligned(16))) tx, ty, zi;
...
ge25519_unpack_negative_vartime(ge25519 *r, const unsigned char p[32]) {
	static const bignum25519 __attribute__((aligned(16))) one = {1};
	static const unsigned char zero[32] = {0};
	unsigned char parity = p[31] >> 7;
	unsigned char check[32];
	bignum25519 __attribute__((aligned(16))) t, root, num, den, d3;
...
ge25519_double_scalarmult_vartime(ge25519 *r, const ge25519 *p1, const bignum256modm s1, const bignum256modm s2) {
	...
	ge25519_pniels __attribute__((aligned(16))) pre1[S1_TABLE_SIZE];
	ge25519 __attribute__((aligned(16))) d1;
	ge25519_p1p1 __attribute__((aligned(16))) t;
	int32_t i;
...
ge25519_scalarmult_base_choose_niels(ge25519_niels *t, const uint8_t table[256][96], uint32_t pos, signed char b) {
	bignum25519 __attribute__((aligned(16))) neg;
	...
	uint8_t __attribute__((aligned(16))) packed[96] = {0};
	packed[0] = 1;
	packed[32] = 1;
...
ge25519_scalarmult_base_niels(ge25519 *r, const uint8_t table[256][96], const bignum256modm s) {
	signed char b[64];
	uint32_t i;
	ge25519_niels __attribute__((aligned(16))) t;
